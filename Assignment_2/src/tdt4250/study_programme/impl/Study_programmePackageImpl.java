...
public class Study_programmePackageImpl extends EPackageImpl implements Study_programmePackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCourse_CourseID(), ecorePackage.getEString(), "courseID", null, 0, 2, Course.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
